...
void TestScrollWindowEx(STRUCT_TestRedrawWindow* ptestRW) {
    ...
    ptestRW->resultRedraw = ScrollWindowEx(hwnd, 0, 300, pUsePrcScroll, pUsePrcClip, RgnUpdate, &ptestRW->prcUpdate, ptestRW->flags);
